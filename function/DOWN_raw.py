...
def grid_corr(xdata, plot=True, thresh=0, cor_method='pearson'):
    '''------------------------------------------------------------------------
...
def downscale_only_Weibull(xdata, Tr, *, thresh=1, L0, acf='mar', dt=3,
...
def fit_yearly_weibull(xdata, thresh=1, maxmiss=40):
    nobsmin = 366 - maxmiss
